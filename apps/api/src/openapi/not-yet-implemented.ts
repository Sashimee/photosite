...
export const NOT_YET_IMPLEMENTED: readonly NotYetImplementedRoute[] = [
  ...
  { method: 'GET', path: '/v1/admin/provenance' },
  { method: 'GET', path: '/v1/admin/provenance/:id' },
  { method: 'POST', path: '/v1/admin/provenance/:id/decision' },
  { method: 'POST', path: '/v1/admin/provenance/:id/recheck' },
