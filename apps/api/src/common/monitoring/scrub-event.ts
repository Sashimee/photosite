...
// Sentry's own request integrations can attach headers, breadcrumb data and
// extra context; the exception filter never passes a request body, but this
// still strips it defensively so a future capture site can't leak one.
